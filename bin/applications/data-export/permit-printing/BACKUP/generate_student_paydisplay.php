...
/**
 * Permit application data export - Student Pay & Display.
 * 
...
try {
    ...
    $dataExportFile = "SDT_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "SDT");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "SDT");
