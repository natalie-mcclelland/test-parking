...
/**
 * Permit application data export - Student Residential (Replacement).
 * 
...
try {
    ...
    $dataExportFile = "RES_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "RES");
