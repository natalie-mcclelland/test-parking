...
/**
 * Permit application data export - Staff Blue Badge (Replacement).
 * 
...
try {
    ...
    $dataExportFile = "ACSF_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "ACSF");
