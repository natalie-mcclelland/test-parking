...
/**
 * Permit application data export - Staff Annual.
 * 
...
try {
    ...
    $dataExportFile = "ANN_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "ANN");
