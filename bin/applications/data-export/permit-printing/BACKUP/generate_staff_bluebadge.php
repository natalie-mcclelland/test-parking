...
/**
 * Permit application data export - Staff Blue Badge.
 * 
...
try {
    ...
    $dataExportFile = "ACSF_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "ACSF");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "ACSF");
