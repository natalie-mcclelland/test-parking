...
/**
 * Permit application data export - Staff Annual (Replacement).
 * 
...
try {
    ...
    $dataExportFile = "ANN_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "ANN");
