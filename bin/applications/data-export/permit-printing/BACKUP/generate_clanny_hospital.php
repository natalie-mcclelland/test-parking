...
/**
 * Permit application data export - Clanny Hospital.
 * 
...
try {
    ...
    $dataExportFile = "HOSP_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "HOSP");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "HOSP");
