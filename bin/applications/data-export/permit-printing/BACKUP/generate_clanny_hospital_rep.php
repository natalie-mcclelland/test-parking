...
/**
 * Permit application data export - Clanny Hospital(Replacement).
 * 
...
try {
    ...
    $dataExportFile = "HOSP_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "HOSP");
