...
/**
 * Permit application data export - Staff Residential.
 * 
...
try {
    ...
    $dataExportFile = "RESF_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "RESF");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "RESF");
