...
/**
 * Permit application data export - Staff Pay & Display.
 * 
...
try {
    ...
    $dataExportFile = "STF_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "STF");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "STF");
