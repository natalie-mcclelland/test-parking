...
/**
 * Permit application data export - Staff Residential (Replacement).
 * 
...
try {
    ...
    $dataExportFile = "RESF_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "RESF");
