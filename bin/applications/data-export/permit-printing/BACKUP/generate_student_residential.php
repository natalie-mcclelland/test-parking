...
/**
 * Permit application data export - Student Residential.
 * 
...
try {
    ...
    $dataExportFile = "RES_IS_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("AP", "RES");
        ...
        $permitApplications2 = $parkingApplication->getPermitApplicationsByStatus("RP", "RES");
