...
/**
 * Permit application data export - Student Pay & Display (Replacement).
 * 
...
try {
    ...
    $dataExportFile = "SDT_RI_" . date('Ymd') . ".csv";
    ...
    try {
        ...
        $permitApplications = $parkingApplication->getPermitApplicationsByStatus("RP", "SDT");
